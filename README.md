...
- Type KPF name, no extension necessary
- Choose path to save into

You will get terminal confirmations of success or failure, but I'm only checking if paths and names are invalid / null.
